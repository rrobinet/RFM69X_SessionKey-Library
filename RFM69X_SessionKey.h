...
// **********************************************************************************
#ifndef RFM69X_SessionKey_h
#define RFM69X_SessionKey_h
#include <RFM69X.h>
...
class RFM69X_SessionKey: public RFM69X {
...
static volatile uint16_t _respDelayTime; 		    // !RVDB used to store the Session KEY challenge response for slow remote nodes
 public:	
    RFM69X_SessionKey(uint8_t slaveSelectPin=RF69_SPI_CS, uint8_t interruptPin=RF69_IRQ_PIN, bool isRFM69HW=false, uint8_t interruptNum=RF69_IRQ_NUM) :
      RFM69X(slaveSelectPin, interruptPin, isRFM69HW, interruptNum) {
    }
